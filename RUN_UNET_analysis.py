...
PATH_res_ed = '/Users/michalablicher/Desktop/Trained_Unet_dice_dia_train_results_mc01.pt'
...
plt.plot(epochs_eval  + 1 , eval_loss , 'r', linestyle = 'dashed', label = 'Validation Loss')
plt.xticks(np.arange(1, 100 + 1, step = 20))
plt.xlabel('Epochs')
