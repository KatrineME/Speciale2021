...
for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    for epoch in range(num_epochs):  # loop over the dataset multiple times
        ...
        for i, (eval_data) in enumerate(eval_dataloader):
            ...
            loss = loss_d #+ loss_lv #+ loss_lv #+ loss_lv + loss_c
    ...
    PATH_model = "/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_dia_100_fold{}.pt".format(fold)
...
plt.savefig('/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_dia_100_CV_scheduler.png')
...
PATH_results = "/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_dia_100_train_results_scheduler.pt"
