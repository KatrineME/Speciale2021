...
if __name__ == "__main__":
    #import torchsummary
    unet = BayesUNet(num_classes=4, in_channels=1, drop_prob= 0.02)
    unet.cuda()
...
for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    optimizer = torch.optim.Adam(unet.parameters(), lr=0.0067, eps=0.0074, weight_decay=0.0033) #LR 
    ...
    PATH_model = "/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_lclv_sys_150e_opt_red_fold{}.pt".format(fold)
...
plt.savefig('/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_lclv_sys_150e_opt_red.png')
...
PATH_results = "/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_lclv_sys_150e_opt_red_train_results.pt"
