...
for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    for epoch in range(num_epochs):  # loop over the dataset multiple times
        ...
        for i, (train_data) in enumerate(train_dataloader):
            ...
            loss = loss_d + loss_lv + loss_c#+ loss_lv
        ...
        for i, (eval_data) in enumerate(eval_dataloader):
            ...
            loss = loss_d + loss_lv + loss_c#+ loss_lv #+ loss_lv + loss_c
...
plt.savefig('/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_sys_100_dice_lclv_scheduler.png')
...
PATH_results = "/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_lvlc_sys_100_train_results_scheduler.pt"
