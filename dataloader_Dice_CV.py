...
for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    for epoch in range(num_epochs):  # loop over the dataset multiple times
        ...
        for i, (train_data) in enumerate(train_dataloader):
            ...
            loss = loss_d + 100*loss_c + 100*loss_lv#+ loss_lv loss with c
        ...
        for i, (eval_data) in enumerate(eval_dataloader):
            ...
            loss = loss_d + 100*loss_c + 100*loss_lv#+ loss_lv #+ loss_lv + loss_c
    ...
    PATH_model = "/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_100lc_100lv_sys_100e_fold{}.pt".format(fold)
...
plt.savefig('/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_sys_100e_dice_100lc100lv_scheduler.png')
...
PATH_results = "/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_sys_100e_100lc100lv_train_results_scheduler.pt"
