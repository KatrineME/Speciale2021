...
for fold, (train_ids, test_ids) in enumerate(kfold.split(dataset)):
    ...
    for epoch in range(num_epochs):  # loop over the dataset multiple times
        ...
        for i, (train_data) in enumerate(train_dataloader):
            ...
            loss = loss_d + 0*loss_c + 20*loss_lv#+ loss_lv loss with c
        ...
        for i, (eval_data) in enumerate(eval_dataloader):
            ...
            loss = loss_d + 0*loss_c + 20*loss_lv#+ loss_lv #+ loss_lv + loss_c
...
plt.savefig('/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_sys_100e_dice_0lc20lv_scheduler.png')
...
PATH_results = "/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_sys_100e_0lc20lv_train_results_scheduler.pt"
