...
for fold in range(0,6):
    if user == 'GPU':
        path_model ='/home/michala/Speciale2021/Speciale2021/Trained_Unet_CE_sys_150e_fold{}.pt'.format(fold)
    if user == 'K':
...
if user == 'GPU':
    PATH_out_soft = '/home/michala/Speciale2021/Speciale2021/Out_softmax_fold_avg_150sys_CE.pt'
if user == 'K':
