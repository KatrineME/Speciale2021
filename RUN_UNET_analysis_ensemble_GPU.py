...
for fold in range(0,6):
    if user == 'GPU':
        path_model ='/home/michala/Speciale2021/Speciale2021/Trained_Unet_dice_lclv_dia_150_fold{}.pt'.format(fold)
    if user == 'K':
...
if user == 'GPU':
    PATH_out_soft = '/home/michala/Speciale2021/Speciale2021/Out_softmax_fold_avg_150dia_dice_lclv.pt'
if user == 'K':
